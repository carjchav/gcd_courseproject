...
The steps perfomed entailed: merging files, putting descriptive variable names, labelling activities in the original data set with descriptive names, picking out the mean and standard deviation measures, and averaging those measures to write a tidy data set.
